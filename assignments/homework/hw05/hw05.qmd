...
rawToChar(as.raw(cutoff+33)) or encoding(cutoff) # see score-to-character mapping
```
...
```{r}
#| eval: false
## Download FASTQ test files as used in the NGS tutorial, or obtain from ShortRead package:
library(ShortRead)
fastq <- list.files(system.file("extdata", "E-MTAB-1147", package = "ShortRead"), full.names=TRUE)
...
## Usage example
# fastq <- fastq <- list.files(system.file("extdata", "E-MTAB-1147", package = "ShortRead"), full.names=TRUE)
# demultiplex_trim(x = fastq[1], barcode = c("TT", "AA", "GG"),
#                 nreads = 50, cutoff = 20)
...
This homework is due **Thursday, May 7th at 6:00 PM**.

## Homework Solutions

See [here](https://raw.githubusercontent.com/tgirke/GEN242/refs/heads/main/assignments/homework/hw05/hw5_solution.R). 

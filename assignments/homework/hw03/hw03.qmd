...
Note, [here](https://raw.githubusercontent.com/tgirke/GEN242/refs/heads/main/assignments/homework/hw03/hw03b_StarterCode.R) is some helper code in R to create the initial matrix programmatically for upload to a spreadsheet program. Alternatively, solve the entire homework by writing an R script.
...
Assemble the results from this homework in one PDF file (HW4.pdf) and upload it to your private GitHub repository under `Homework/HW3/HW3.pdf`.

## Due date

This homework will be due Apr 23th at 6:00 PM.

## Homework Solutions

See here: [HTML](https://raw.githubusercontent.com/tgirke/GEN242/refs/heads/main/assignments/homework/hw03/hw3_solution/HW3_key.html) or [PDF](https://github.com/tgirke/GEN242/blob/main/assignments/homework/hw03/hw3_solution/HW3_key.pdf) format.

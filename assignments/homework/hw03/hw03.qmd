...
Note, [here](https://github.com/tgirke/GEN242/blob/main/assignments/homework/hw02/HW04b_StarterCode.R) is some helper code in R to create the initial matrix programmatically for upload to a spreadsheet program. Alternatively, solve the entire homework by writing an R script.

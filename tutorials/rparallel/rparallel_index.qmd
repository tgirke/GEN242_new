...
<p align="right">
  ...
  <a href="https://girke.bioinformatics.ucr.edu/GEN242/slides/rhpc/rhpc_page.html" target="_blank" rel="noopener noreferrer" style="text-decoration:none">
    <img src="https://img.shields.io/badge/Slideshow-blue?style=for-the-badge" alt="Slideshow">
  </a>
  <a href="https://raw.githubusercontent.com/tgirke/GEN242/refs/heads/main/tutorials/rparallel/rparallel_index.qmd" target="_blank" rel="noopener noreferrer" style="text-decoration:none">
...
quarto render rparallel_index.qmd
Render qmd from R:
quarto::quarto_render("rparallel_index.qmd")
-->

## Overview 

- A general introduction to this topic is in the [Linux and HPCC Cluster](../linux/index.qmd#queuing-system-slurm) manual of the GEN242 site.
...
__1.__ Create Slurm submission script, here called [script_name.sh](https://github.com/tgirke/GEN242/blob/main/tutorials/rparallel/script_name.sh) with:
...
__2.__ Submit R script called [my_script.R](https://raw.githubusercontent.com/tgirke/GEN242/refs/heads/main/tutorials/rparallel/my_script.R) by above Slurm script with:
...
- To simplify the evaluation of the R code on the following slides, the
  ...
  [here](https://raw.githubusercontent.com/tgirke/GEN242/refs/heads/main/tutorials/rparallel/R_for_HPC_demo.R).
...
done <- submitJobs(ids, reg=reg, resources=list(partition="gen242", account="gen242", walltime=120, ntasks=1, ncpus=1, memory=1024))

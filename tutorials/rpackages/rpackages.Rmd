...
in one of the programming exercises [here](https://girke.bioinformatics.ucr.edu/GEN242/tutorials/rprogramming/rprogramming/#custom-functions).

```{r use_package_fct, eval=FALSE}
library(mypackage)
?myMAcomp

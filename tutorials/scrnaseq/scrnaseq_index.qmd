...
To work with this tutorial, download its `qmd` file (from 
[here](https://raw.githubusercontent.com/tgirke/GEN242/main/tutorials/scrnaseq/scrnaseq_index.qmd), 
or use blue QMD button above). In addition, download the required `targetsPE.txt` and `countDFeByg.xls` files 
from [here](https://github.com/tgirke/GEN242/tree/main/tutorials/scrnaseq/results) to a new directory named `results`.

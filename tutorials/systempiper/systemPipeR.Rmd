...
```{r sysargs2b, eval=FALSE, results="hide"}
library(systemPipeR)
command2 <- "
    hisat2 \
...
<div align="center">FASTQ quality report </div></br>
...
<div align="center">Correlation dendrogram of samples for _`rlog`_ values. </div></br>
...
<div align="center">Up and down regulated DEGs identified by `edgeR`. </div></br>
...
<div align="center">Venn Diagram for 4 Up and Down DEG Sets. </div></br>
...
<div align="center">GO Slim Barplot for MF Ontology.</div></br>
...
<div align="center">Heat map with hierarchical clustering dendrograms of DEGs.</div></br>

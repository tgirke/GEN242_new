...
Terminal-based Working Environment for R: 
![Nvim-R-Tmux](images/Nvim-R.gif){fig-align="center"}.
...
The following gives a short introduction into the basic usage of Nvim-R-Tmux. The short overview is on this [slide](https://docs.google.com/presentation/d/1AYVON1pS-vBe5NLp89L2HMBZZjr6L-Z20zN6ZG9r7L0/edit#slide=id.p):
...
* `:set tabstop=20`: quick and simple way to view tab delimited tables

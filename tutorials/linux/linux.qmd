...
Since all major operating systems can provide a Linux command-line environment
with minimal setup, users may want to enable such an environment on their own
